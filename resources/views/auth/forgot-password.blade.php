	...
	<div class="login-wrap d-flex align-items-center flex-wrap justify-content-center">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6">
					<img src="{{ asset('vendors/images/forgot-password.png') }}" alt="Forgot Password" />
				</div>
				<div class="col-md-6">
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form method="POST" action="{{ route('password.email') }}">
							...
							{{-- Show errors --}}
							<x-input-error :messages="$errors->get('email')" class="mb-3 text-danger" />

							{{-- Show session status (if email sent) --}}
							@if (session('status'))
							...
							<div class="row align-items-center">
								...
								<div class="col-2 text-center">
									<span class="font-16 weight-600" data-color="#707373">OR</span>
								</div>
								<div class="col-5">
									<div class="input-group mb-0">
