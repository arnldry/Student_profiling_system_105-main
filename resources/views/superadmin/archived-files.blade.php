...
<body>
    ...
    <div class="main-container">
        <div class="xs-pd-20-10 pd-ltr-20">
            ...
            <!-- Archived School Years Container -->
            <div class="title pb-20">
                <h2 class="h3 mb-0">Archived School Years</h2>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.show-students').click(function () {
                ...
                // Collapse table if same year clicked again
                ...
                $.ajax({
                    url: `/superadmin/archived-students/school-year/${schoolYearId}`, // FIXED URL
                    type: 'GET',
