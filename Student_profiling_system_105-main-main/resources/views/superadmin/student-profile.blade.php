    ...
    <div class="main-container">
        <div class="xs-pd-20-10 pd-ltr-20">
            <div class="title pb-20">
                <h2 class="h3 mb-0">Student List tae</h2>
            </div>
                        ...
                        <tbody>
                            @foreach($users as $user)
                                ...
                                <tr>
                                    ...
                                    <div class="modal fade" id="editInfoModal{{ $user->id }}" tabindex="-1" aria-labelledby="editInfoModalLabel{{ $user->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('superadmin.update-student-info', $user->id) }}" method="POST" enctype="multipart/form-data" class="edit-student-form" data-user-id="{{ $user->id }}">
                                                    @csrf
                                                        ...
                                                        <div class="edit-form-step active" id="edit-step-1-{{ $user->id }}">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 form-group">
                                                                    ...
                                                                    <select name="religion" id="edit-religion-{{ $user->id }}" class="form-control religion-select" data-user-id="{{ $user->id }}" required>
                                                                        <option value="">Select Religion</option>
                                                                        <option value="Catholic" {{ ($info->religion ?? '') == 'Catholic' ? 'selected' : '' }}>Catholic</option>
                                                                        <option value="Protestant" class="has-submenu" {{ ($info->religion ?? '') == 'Protestant' || ($info->religion_denomination ?? '') ? 'selected' : '' }}>Protestant ▶</option>
                                                                        ...
                                                                        <option value="Hinduism" {{ ($info->religion ?? '') == 'Hinduism' ? 'selected' : '' }}>Hinduism</option>
                                                                        <option value="Judaism" {{ ($info->religion ?? '') == 'Judaism' ? 'selected' : '' }}>Judaism</option>
                                                                        <option value="Agnostic" {{ ($info->religion ?? '') == 'Agnostic' ? 'selected' : '' }}>Agnostic</option>
                                                                        <option value="Atheist" {{ ($info->religion ?? '') == 'Atheist' ? 'selected' : '' }}>Atheist</option>
                                                                        <option value="Others" {{ ($info->religion ?? '') == 'Others' ? 'selected' : '' }}>Others</option>
                                                                    </select>
                                                                    <input type="hidden" name="religion_denomination" id="edit-religion-denomination-{{ $user->id }}" value="{{ $info->religion_denomination ?? '' }}">
                                                                </div>
                                                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="modal fade" id="protestantDenominationModal{{ $user->id }}" tabindex="-1" aria-labelledby="protestantDenominationLabel{{ $user->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header bg-primary text-white">
                                                    <h5 class="modal-title" id="protestantDenominationLabel{{ $user->id }}">
                                                ...
                                                <div class="modal-body">
                                                    <div class="denomination-list">
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Lutheran')">
                                                            <div class="denomination-text">Lutheran</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Anglican / Episcopal')">
                                                            <div class="denomination-text">Anglican / Episcopal</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Baptist')">
                                                            <div class="denomination-text">Baptist</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Methodist')">
                                                            <div class="denomination-text">Methodist</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Presbyterian')">
                                                            <div class="denomination-text">Presbyterian</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Calvinist / Reformed')">
                                                            <div class="denomination-text">Calvinist / Reformed</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Pentecostal (e.g., Assemblies of God)')">
                                                            <div class="denomination-text">Pentecostal (e.g., Assemblies of God)</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Evangelical')">
                                                            <div class="denomination-text">Evangelical</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Seventh-day Adventist')">
                                                            <div class="denomination-text">Seventh-day Adventist</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Church of Christ')">
                                                            <div class="denomination-text">Church of Christ</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Born Again / Bible churches')">
                                                            <div class="denomination-text">Born Again / Bible churches</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Non-denominational Christian churches')">
                                                            <div class="denomination-text">Non-denominational Christian churches</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Jehovah\'s Witnesses')">
                                                            <div class="denomination-text">Jehovah's Witnesses</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Mormons')">
                                                            <div class="denomination-text">Mormons</div>
                                                        </div>
                                                        <div class="denomination-item" onclick="selectDenomination({{ $user->id }}, 'Iglesia ni Cristo (INC)')">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.edit-student-form').forEach(form => {
                ...
                const religionSelect = modal.querySelector(`#edit-religion-${userId}`);
                if (religionSelect) {
                    religionSelect.addEventListener('change', function() {
                        ...
                        if (this.value === 'Protestant') {
                            $(`#protestantDenominationModal${userId}`).modal('show');
                        }
                    });
                }
        ...
        function selectDenomination(userId, denomination) {
            const religionSelect = document.getElementById(`edit-religion-${userId}`);
            const denominationField = document.getElementById(`edit-religion-denomination-${userId}`);
            ...
            $(`#protestantDenominationModal${userId}`).modal('hide');
        }
